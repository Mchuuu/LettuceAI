...
const PARAMETER_LABELS: Record<keyof AdvancedModelSettings, string> = {
  ...
  responseLengthPreset: "Response Length",
  responseLengthChars: "Custom Response Length",
...
const PARAMETER_DESCRIPTIONS: Record<keyof AdvancedModelSettings, string> = {
  ...
  responseLengthPreset: "Local prompt-based response length preset",
  responseLengthChars: "Custom Chinese character limit used by the response length prompt",
