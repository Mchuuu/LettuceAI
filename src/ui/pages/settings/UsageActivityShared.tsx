...
export function getOperationColor(type: string): string {
  const colorsMap: Record<string, string> = {
    ...
    companion_state: "#f472b6",
    companion_soul_writer: "#c084fc",
    scene_generation: "#38bdf8",
    lorebook_generation: "#34d399",
...
export function getOperationLabel(
  ...
  const labels: Record<string, string> = {
    ...
    companion_state: t("usageAnalytics.shared.operations.companionState"),
    companion_soul_writer: t("usageAnalytics.shared.operations.companionSoulWriter"),
    scene_generation: t("usageAnalytics.shared.operations.sceneGeneration"),
    lorebook_generation: t("usageAnalytics.shared.operations.lorebookGeneration"),
